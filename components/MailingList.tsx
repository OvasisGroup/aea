...
export default function MailingList() {
  return (
    <div className='bg-[url("/images/tcblack.jpg")] py-8 bg-cover bg-center flex items-center justify-between px-6'>
        <div className='container mx-auto md:flex items-center justify-between px-6'>
          ...
          <form className='flex items-center justify-between bg-white mt-4 md:mt-0'>
